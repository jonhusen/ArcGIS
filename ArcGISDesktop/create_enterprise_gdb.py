...
parser.add_option ("--auth", 
				   dest="Account_authentication", 
				   type ="choice", 
				   choices=['DATABASE_AUTH', 'OPERATING_SYSTEM_AUTH'], 
...
parser.add_option ("-P", 
				   ...
				   type="string", 
				   default="", 
				   help="DBMS administrator password")
parser.add_option ("--schema", 
				   dest="Schema_type", 
				   type="choice", 
				   choices=['SDE_SCHEMA', 'DBO_SCHEMA'], 
				   default="SDE_SCHEMA", 
...
parser.add_option ("-u", 
				   ...
				   type="string", 
				   default="sde", 
				   help="Geodatabase administrator user name; Must always be sde for PostgreSQL, sde-schema geodatabases in SQL Server, and master sde geodatabase in Oracle")
parser.add_option ("-p", 
				   dest="Gdb_admin_pwd", 
				   type="string", 
				   default="", 
...
parser.add_option ("-l", 
				   ...
				   type="string", 
				   default="//srvr-file.spectrumeng.local/administrative/Program Disks/ESRI/Version 10/keycodes_srvr-arcgis", 
...
try:
	...
	try:
		...
		arcpy.CreateEnterpriseGeodatabase_management(database_platform=database_type,
